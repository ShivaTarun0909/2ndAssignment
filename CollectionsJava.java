...
public class CollectionsJava {
    public static   void main(String[] args) {
        Employee em1 = new Employee("Virat", "Kohli", 23, 39000);
        Employee em2 = new Employee("Rohit", "Sharma", 24, 37000);
        Employee em3 = new Employee("KL", "Rahul", 22, 36000);
        Employee em4 = new Employee("Rishab", "Pant", 25, 37500);
        Employee em5 = new Employee("Jasprit", "Bumrah", 35, 40000);
